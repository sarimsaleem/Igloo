...
const SuperChargeYourExperiance = () => {
    const clients = [
            ...
            <div className='getnotice'>
                <Container>
                    <div className="stillQuestion-text-container">
                        <h1 style={{lineHeight: "45px"}}e className="stillQuestion-heading">Get Ahead of Your Competitors
                        </h1>
                        <div className="stillQuestion-seperator"></div>
                        <p className="stillQuestion-text">
                        Running a successful business is not easy, but with the right help, you can always stay ahead of the curve. If you want to give your competitors a run for their money, contact our experts at Igloo today and book a free consultation.</p>
...
export default SuperChargeYourExperiance