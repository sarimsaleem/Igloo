                ...
                <Row>
                    <Col md={6}>
                        <Accordion.Item className='accordion-box' eventKey="0">
                            <Accordion.Header className='accordion-heading'>Do you guarantee results?
                            </Accordion.Header>
                            <Accordion.Body >
                                Yes, we do. When digital marketing is done right, then an agency should be able to guarantee results.              </Accordion.Body>
                        </Accordion.Item>
                    </Col>
                    <Col md={6}>
                ...
                <Row>
                    <Col md={6}>
                        <Accordion.Item className='accordion-box' eventKey="4">
                            ...
                            <Accordion.Body >
                            Yes, we do. Additionally, we provide a real-time report that clients can access 24/7 through a dedicated link.
                        </Accordion.Body>
                        </Accordion.Item>
                    </Col>
                    <Col md={6}>
