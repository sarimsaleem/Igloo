            ...
            <div className='getnotice'>
                <Container>
                    <div className="stillQuestion-text-container">
                        <h1 style={{lineHeight: "45px"}}e className="stillQuestion-heading">Let Your Email Marketing Campaign Shine</h1>
                        <div className="stillQuestion-seperator"></div>
                        <p className="stillQuestion-text">
                        For some businesses, tried and tested marketing strategies are the way to go, so if your email campaign could use a facelift, we at Igloo can provide you with everything you need. Just give us a call to learn more about our full-service email marketing campaign offerings.</p>
